...
class GameplayState(State):
    def enter(self, **kwargs):
        ...
        # Spawners
        self.spawners = [
            Spawner(self.level.spawn.interval, robots_defs, i, p, self.path_station_ts[i], self.conveyor_speed)
...
class Spawner:
    def __init__(self, interval, robots_defs, path_id, path_pts, station_ts, speed):
        self.interval = float(interval)
        self.timer = 0.0
        self.robot_defs = robots_defs  # list[(type, weight, params)]
